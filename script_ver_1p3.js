...
for (i = 0; i < toggler.length; i++) {
    toggler[i].addEventListener("click", function() {
        ...
        document.getElementById("inputBox").placeholder = "Please select the proper violation type items";
    });
}
// END1: 
...
for (i = 0; i < frame1_click.length; i++) {
    frame1_click[i].addEventListener("click", function() {
        //To disable the add waiver button once violation item is clicked
        ...
        inputElement.value = ''
        document.getElementById("inputBox").disabled = true;
        document.getElementById("inputBox").placeholder = "Please select the violation from the error window";
...
selectElement.addEventListener("change", (event) => {
    ...
    document.getElementById("inputBox").placeholder = "Please provide the proper Justification to Add/Delete the waivers";
});
...
function add_waiver_clicked() {
    ...
    inputElement.value = ''  //To clear the input filed once add waiver is clicked
    document.getElementById("inputBox").disabled = true; 
    document.getElementById("inputBox").placeholder = "Please select the violation from the error window";
}
// END3:
...
inputsProvided.addEventListener('input', function() {
    ...
    if (inputsProvided.value.trim() == '') {
        // document.getElementById("addWaiver").style.opacity = 0;
        document.getElementById("addWaiver").classList.remove("show_button")
        document.getElementById("addWaiver").classList.add("hide_button")
    }
});
